		    ...
		    $(document).ready(function() {
	            $('#btnDownload').click(function() {
	            		if($('#fromdate').val()==''){
	            			swal({
								title : "Error",
								text : "From Date should not Empty!",
								type : "error",
								showCancelButton : false,
								confirmButtonClass : 'btn btn-theme04',
	...
	<div class="col-lg-12 column" style="width: 100%">
		<div class="portlet">
			<div class="portlet-header">
				<p>Reports</p>
				<fieldset id="requestType" style="display: none">
					<span class="ui-text"> <label for="requestType">
							Select Request Type</label></span> <input type="radio" name="requestType"
						id="tcode_radio" value="T" checked="checked" />T-Code
				</fieldset>
			</div>
			<div id="requestTocde">
				<div class="portlet">
					<form id="downloadForm" action="downloadExcel" class= "float: right" method="post" enctype="application/x-www-form-urlencoded">
							...
							<table
								...
								<tr style="width: 100%">
									...
									<td style="width: 40%"><select id="sapCompanyCodes"
										class="sapCompanyCodes" name="sapCompCode">
									</select></td>
									<td style="width: 10%">Module list <font color=red>★</font></td>
									<td style="width: 40%"><select id="modulelist"
										name="module">
									</select></td>
								</tr>
								<tr style="width: 100%;" class="fortime">
									<td style="width: 10%">From Date <font color=red>★</font></td>
									...
									<td style="width: 10%">To Date <font color=red>★</font></td>
									<td style="width: 40%"><div class="input-group">
											<div class="input-group-addon">
												<i class="fa fa-calendar"> </i>
											</div>
								...
								<tr>
									<td>
										<div>
											<span class="showback">
												<button id="btnDownload" class="btn btn-success" type="button">
				...
				<div class="col-lg-12 column" style="width: 60%; display: none;">
					<div class="portlet">
						<div class="portlet-header">
				...
				<!-- /content-panel -->
				<div class="col-lg-12 column" style="width: 40%; display: none;">
					<div class="portlet">
						<div class="portlet-header">
