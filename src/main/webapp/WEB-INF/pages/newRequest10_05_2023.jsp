							...
							<table
							 ...
							 <td style="width: 40%"><input id="tcode" name="tcode"
								...
								<td style="width: 10%" class="vplant">
									...
									<td style="width: 30%"><input name="reason"
								...
								<!-- <tr style="width: 100%">
									...
									<td style="width: 10%" class="tcodes">
										<button id="btcodes" type="button" class="btn btn-success ">
											<i class="fa fa fa-plus "></i> Add T-codes 
										</button>
									</td>
										<td style="width: 30%" class="vplant">
										<button id="bplant" type="button" class="btn btn-success ">
											<i class="fa fa fa-plus"></i> Add Plants 
										</button>
									</td>
								</tr>	
								<tr style="width: 100%">	<td style="width: 10%">Reason for t-code access</td>
								...
								<tr style="width: 100%">
									...
									<td style="width: 10%; display: none;" class="vpgroup">
										<button id="bPurGrp" type="button" class="btn btn-success ">
											<i class="fa fa fa-plus "></i> Add Purchasing Grp
										</button>
									</td>
						...
						<div class="portlet-content form-group">
							...
							<table
								...
								<tr style="width: 100%">
									...
									<td style="width: 50%"><input name="reasonrole"
					...
					<div class="portlet-content form-group">
						...
						<table
							...
							<tr style="width: 100%">
								...
								<td style="width: 50%"><textarea rows="2" name="ref_reason"
										class="form-control" id="ref_reason"
					...
					<table id="tcodeTable"
						...
						<thead>
							<tr>
								...
								<th style="width: 20%">Type of role</th>
								<th style="width: 35%">T-code Description</th>
	...
	<div id="roletoolbars" style="display: none">
		<span class="showback">
			<button id="btnAssignRoles" class="btn btn-success" type="button">
				<i class="glyphicon glyphicon-edit"></i> Add Roles
			</button>
		</span>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div>
						...
						<img src="resources/assets/img/loadingr.gif" />
