...
public class AuthManagerImpl implements AuthManager{
	 private static final String CONTEXT_FACTORY_CLASS = "com.sun.jndi.ldap.LdapCtxFactory";;
	    ...
	    public AuthManagerImpl( ) {
	        this.domainName = "DSL.COM".toUpperCase();
	        System.out.println(" this.domainName"+ this.domainName);
	        try {
	    ...
	    private static String[] nsLookup(String argDomain) throws Exception {
	        try {
	            ...
	            for (int i = 0; i < 3; i++) {
	                ...
	                System.out.println("Ved +++++++++++++++++++++++++++++++++++++++++++++++ END");
	                System.out.println("srv   "+a.toString());
	                if (a != null) {
